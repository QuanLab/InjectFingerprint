...
class Client(Iface):
  ...
  def multiply(self, n1):
    ...
    Parameters:
     - n1
    """
    self.send_multiply(n1)
    return self.recv_multiply()

  def send_multiply(self, n1):
...
class Processor(Iface, TProcessor):
  ...
  def process_multiply(self, seqid, iprot, oprot):
    ...
    result = multiply_result()
    try:
      result.success = self._handler.multiply(args.n1)
